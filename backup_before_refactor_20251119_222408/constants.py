...
def get_speed_of_sound(temp_celsius: float = 20.0) -> float:
    """
    Calcula la velocidad del sonido en aire a una temperatura dada.
    
    Args:
        temp_celsius: Temperatura en grados Celsius.
    
    Returns:
        Velocidad del sonido en m/s.
    """
    return 331.3 * np.sqrt(1 + temp_celsius / 273.15)
