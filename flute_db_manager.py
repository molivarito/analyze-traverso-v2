...
class FluteDBManager:
    ...
    def get_all_flutes_for_statistics(self) -> List[Dict[str, Any]]:
        """
        Obtiene todas las flautas con información básica para reportes estadísticos.
        ...
        try:
            cursor.execute("""
                SELECT id, flute_model, json_source_path, created_at, updated_at
                FROM flutes
                ORDER BY flute_model
            """)
    ...
    def get_flute_geometry_for_statistics(self, flute_id: int) -> Dict[str, Any]:
        """
        Obtiene la geometría completa de una flauta para análisis estadístico.
